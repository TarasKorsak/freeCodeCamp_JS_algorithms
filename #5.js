...
// 	for (i1 = 0; i1 < arr[i1].length - 1; i1 += 1) {
// 		for (i2 = 0; i2 < arr[i1].length - 2; i2 += 1) {
// 			maxItem = isBigger(a[i1][i2], a[i1][i2 +1]);
// 		}
// 		finalArr[i1] = maxItem;
// 	}
//   return finalArr;
...
// largestOfFour([[4, 5, 1, 2], [13, 27, 18, 26], [32, 35, 37, 9], [1000, 1001, 857, 1]]);
